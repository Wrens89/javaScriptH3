...
const information = {
  firstName: "Renske",
  lastName: "Smith-Nauta",
  age: 32,
  dateOfBirth: "January 20th",
}
...
console.log("Hoi! Ik ben " + information.firstName + ", ik ben " + information.age + " jaar oud.");
...
const waterCooker = "De " + product.productName + " is gemaakt van " + product.material[0] + " en " + product.material[1];
console.log(waterCooker);
